...
> - **2b — not started**: items 5, 6, 7, and 8's Recurring section (`RecurringTemplate`, `recurringTemplateId`, the `'recurring'` source value, daily-jobs drafting, duplicate-defense fingerprint, template tools).
