...
- **All AI-authored content renders inside `AiSurface`** (the one wrapper that applies the steel-blue→teal AI convention + ✦ badge). If you add a surface that shows model output, wrap it.
