...
export type RentChargeOption = z.infer<typeof s.RentChargeOptionSchema>;
export type OpenRentChargesResponse = z.infer<typeof s.OpenRentChargesResponseSchema>;
export type AmbiguousRentDeposit = z.infer<typeof s.AmbiguousRentDepositSchema>;
